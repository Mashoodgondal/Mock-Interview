...
// import img1 from '../../../public/images/new2.jpg'

// import img2 from '../../../public/images/new1.jpeg'
        ...
        <div className="min-h-screen bg-white dark:bg-gray-600/50 transition-colors duration-300">
            <section className="relative py-20 px-4 bg-gradient-to-br from-blue-50 to-purple-50 dark:from-gray-600/50 dark:to-gray-600/60">
                ...
                <div className="relative max-w-7xl mx-auto text-center">
                    ...
                    <div className="flex flex-wrap justify-center gap-4">
                        <Link href="/dashboard">
                            <LocalButton title="Start Your Journey" />
                        </Link>
                    </div>
                </div>
            </section>
                        ...
                        {teamMembers.map((member, index) => (
                            <div key={index} className="text-center group">
                                <div className="relative mb-6 inline-block">
                                    <div className="w-40 h-40 rounded-full overflow-hidden mx-auto shadow-lg group-hover:shadow-xl transition-all duration-300 border-4 border-white dark:border-gray-700">
                                        <Image
                                            src={member.image}
                                            alt={member.name}
                                            width={160}
                                    ...
                                    <div className="absolute inset-0 w-40 h-40 rounded-full mx-auto bg-gradient-to-r from-blue-600/10 to-purple-600/10 group-hover:from-blue-600/20 group-hover:to-purple-600/20 transition-all duration-300"></div>
                                </div>
